...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`${activeMenu ? "visible" : "invisible"
      ...
      >
        ...
        ></div>
        <nav
          className={`${activeMenu ? "-translate-x-0" : "-translate-x-full"
            ...
            <div className="flex items-center justify-between mt-10 font-semibold text-gray-200 dark:text-gray-800 rtl:font-casablanca ltr:font-summer">
              ...
              <div className="flex gap-3 contact">
                <a
                  ...
                  href="https://www.github.com/Akinz-bobo"
                >
                  <BsGithub />
                </a>
                <a
                  ...
                  rel="noreferrer"
                  className="hover:scale-150"
                  href="https://www.linkedin.com/in/adeyemo-akinola-8b620418b/"
                >
                  <BsLinkedin />
                </a>
                <a
